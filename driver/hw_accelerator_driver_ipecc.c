...
#define IPECC_W_CTRL			(ipecc_baddr + IPECC_ALIGNED(0x00))
#define IPECC_W_WRITE_DATA		(ipecc_baddr + IPECC_ALIGNED(0x08))
#define IPECC_W_R0_NULL 		(ipecc_baddr + IPECC_ALIGNED(0x10))
#define IPECC_W_R1_NULL 		(ipecc_baddr + IPECC_ALIGNED(0x18))
#define IPECC_W_PRIME_SIZE 		(ipecc_baddr + IPECC_ALIGNED(0x20))
#define IPECC_W_BLINDING 		(ipecc_baddr + IPECC_ALIGNED(0x28))
/*	-- reserved                                                               -- 0x30  */
#define IPECC_W_SHUFFLE 		(ipecc_baddr + IPECC_ALIGNED(0x38))
#define IPECC_W_IRQ     		(ipecc_baddr + IPECC_ALIGNED(0x40))
#define IPECC_W_ERR_ACK			(ipecc_baddr + IPECC_ALIGNED(0x48))
#define IPECC_W_SMALL_SCALAR		(ipecc_baddr + IPECC_ALIGNED(0x50))
/*	-- reserved                                                           0x52...0x78  */
#define IPECC_W_DBG_BKPT 		(ipecc_baddr + IPECC_ALIGNED(0x80))
#define IPECC_W_DBG_STEPS 		(ipecc_baddr + IPECC_ALIGNED(0x88))
#define IPECC_W_DBG_TRIG_ACT 		(ipecc_baddr + IPECC_ALIGNED(0x90))
#define IPECC_W_DBG_TRIG_UP		(ipecc_baddr + IPECC_ALIGNED(0x98))
#define IPECC_W_DBG_TRIG_DOWN 		(ipecc_baddr + IPECC_ALIGNED(0xa0))
#define IPECC_W_DBG_OP_ADDR   		(ipecc_baddr + IPECC_ALIGNED(0xa8))
#define IPECC_W_DBG_WR_OPCODE 		(ipecc_baddr + IPECC_ALIGNED(0xb0))
#define IPECC_W_DBG_TRNGCTR 		(ipecc_baddr + IPECC_ALIGNED(0xb8))
#define IPECC_W_DBG_TRNGCFG 		(ipecc_baddr + IPECC_ALIGNED(0xc0))
#define IPECC_W_DBG_FP_RADDR  		(ipecc_baddr + IPECC_ALIGNED(0xc8))
...
/***********************************************************/
/* read-only registers */
#define IPECC_R_STATUS  		(ipecc_baddr + IPECC_ALIGNED(0x00))
#define IPECC_R_READ_DATA  		(ipecc_baddr + IPECC_ALIGNED(0x08))
#define IPECC_R_CAPABILITIES  		(ipecc_baddr + IPECC_ALIGNED(0x10))
/*	-- reserved                                                           0x18...0x18 */
#define IPECC_R_PRIME_SIZE  		(ipecc_baddr + IPECC_ALIGNED(0x18))
#define IPECC_R_DEBG_CAPABILITIES_0	(ipecc_baddr + IPECC_ALIGNED(0x20))
#define IPECC_R_DEBG_CAPABILITIES_1	(ipecc_baddr + IPECC_ALIGNED(0x28))
#define IPECC_R_DEBG_CAPABILITIES_2	(ipecc_baddr + IPECC_ALIGNED(0x30))
/*	-- reserved                                                           0x28...0x78 */
#define IPECC_R_DBG_STATUS  		(ipecc_baddr + IPECC_ALIGNED(0x80))
#define IPECC_R_DBG_RMN_STEPS  		(ipecc_baddr + IPECC_ALIGNED(0x88))
#define IPECC_R_DBG_TIME  		(ipecc_baddr + IPECC_ALIGNED(0x90))
/* Time to fill the RNG raw FIFO in cycles */
#define IPECC_R_DBG_RAWDUR  		(ipecc_baddr + IPECC_ALIGNED(0x98))
#define IPECC_R_DBG_FLAGS  		(ipecc_baddr + IPECC_ALIGNED(0xa0))
/*	-- reserved                                                           0xa0...0xa8 */
#define IPECC_R_DBG_READ_OP  		(ipecc_baddr + IPECC_ALIGNED(0xb0))
#define IPECC_R_DBG_TRNG_STAT  		(ipecc_baddr + IPECC_ALIGNED(0xb8))
/* Read TRNG data */
#define IPECC_R_DBG_TRNG_DATA  		(ipecc_baddr + IPECC_ALIGNED(0xc0))
#define IPECC_R_DBG_FP_RDATA  		(ipecc_baddr + IPECC_ALIGNED(0xc8))
